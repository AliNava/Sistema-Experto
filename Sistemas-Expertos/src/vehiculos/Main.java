...
public class Main {
    ...
    public static void main(String[] args) 
    {
        ...
        switch(opcion)
        {
                ...
                if(verificarCantidad(vehiculos))
                {
                    ...
                    {    
                        ...
                        if(verificarCantidad(vehiculos))
                        {
                            ...
                            vehiculos = preguntaCajon(vehiculos,cajones);
                            if(verificarCantidad(vehiculos))
                            {
                                if(cajones)
                                {
            ...
            case 1:
                ...
                vehiculos = preguntaMotor(vehiculos,vehiculoSeleccionado.motor);
                ...
                {
                   vehiculos = preguntaPuertas(vehiculos,vehiculoSeleccionado.numPuertas[i]);
                }
                ...
                vehiculos = preguntaLlantas(vehiculos,vehiculoSeleccionado.numllantas);
                System.out.println("\nLlantas ("+vehiculoSeleccionado.numllantas+") ");
                for(Vehiculo vehiculo : vehiculos){System.out.print(vehiculo.nombre+",");}
                System.out.println("");
                if (vehiculos.size()<=1) { System.exit(0);}
                
                vehiculos = preguntaCajon(vehiculos,vehiculoSeleccionado.cajon);
                System.out.println("\nCajon ("+vehiculoSeleccionado.cajon+") ");
                for(Vehiculo vehiculo : vehiculos){System.out.print(vehiculo.nombre+",");}
                System.out.println("");
                if (vehiculos.size()<=1) { System.exit(0);}
                
                vehiculos = preguntaPasajeros(vehiculos,vehiculoSeleccionado.numPasajeros);
    ...
    static public ArrayList<Vehiculo> preguntaCajon(ArrayList<Vehiculo> vehiculos,boolean cajones)
    {
        ArrayList<Integer> borrar = new ArrayList<Integer>();
